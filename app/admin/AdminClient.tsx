      ...
      <div className="admin-dashboard">
        ...
        <section className="panel subagent-log-panel">
          ...
          <p className="panel-help">
            퇴직생활연구소 AI 구성원 33명과 분야별 에이전트 6개의 실시간 작업 보고서, 실행 상태, 입출력 및 로그 내역을 통합 조회합니다. 각 항목을 클릭하면 전체 작업 내역과 상세 보고서를 확인할 수 있습니다.
          </p>
        ...
        <section className="panel internal-audit-panel">
          ...
          <p className="panel-help">{auditScope || "퇴직생활연구소 전 프로젝트 업무"}를 대상으로 사규·인사·콘텐츠·품질·보안 증거를 점검합니다.</p>

...
export const metadata: Metadata = {
  title: "편집부 소개",
  description: "퇴.기.사 편집부장 데스크와 분야별 AI 편집자 6명의 역할과 콘텐츠 책임 범위를 소개합니다.",
  alternates: { canonical: "/author" },
};

export default function Author() {
  return <>
    <InnerHeader path="/author" eyebrow="EDITORIAL TEAM" title="퇴.기.사 편집부" description="데스크가 발행 기준을 책임지고, 분야별 편집자 6명이 공식 원문과 실행 자료를 바탕으로 글을 준비합니다." />
    <main className="content-shell article-copy policy-copy">
      ...
      <section className="editorial-roster" aria-labelledby="editorial-roster-title">
        <h2 id="editorial-roster-title">분야별 편집자 6명</h2>
      ...
      <p className="editorial-count">편집부 구성원 {allEditorialAuthors.length}명 · 편집부장 1명, 분야별 편집자 6명</p>
    </main>
    <SiteFooter />
  </>;
}

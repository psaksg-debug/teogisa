...
export const metadata:Metadata={title:"이용약관",description:"퇴직생활연구소의 콘텐츠, 계산 도구, 외부 링크와 이용 책임에 관한 기본 조건입니다.",alternates:{canonical:"/terms"}};
...
export default function Terms(){return <><InnerHeader path="/terms" eyebrow="TERMS OF USE" title="사이트 이용약관" description="시행일: 2026년 8월 14일"/><main className="content-shell article-copy policy-copy">
  <h2>제공하는 서비스</h2><p>퇴직생활연구소는 퇴직 준비, 생활비, 지원제도, 새로운 일과 건강에 관한 일반 정보와 브라우저 기반 계산 도구를 제공합니다. 별도 표시가 없는 공개 콘텐츠는 회원가입 없이 이용할 수 있습니다.</p>
  ...
  <h2>광고와 제휴</h2><p>광고 또는 제휴가 포함되면 콘텐츠와 구분해 표시합니다. 광고주의 상품·서비스와 거래 조건은 해당 광고주가 책임지며, 사이트는 광고 클릭이나 구매를 요구하지 않습니다.</p>
  <h2>약관 변경과 문의</h2><p>서비스 또는 관련 법령이 바뀌면 이 약관을 수정할 수 있으며 시행일을 페이지에 표시합니다. 이용약관과 콘텐츠 오류에 관한 문의는 <a href="/contact">문의·오류 제보</a> 또는 <a href="mailto:master@adbles.com">master@adbles.com</a>으로 보내주세요.</p>
</main><SiteFooter/></>}

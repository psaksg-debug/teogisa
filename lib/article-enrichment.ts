...
const categoryOfficialLinks:Record<string,Array<{label:string;url:string}>>={
  "퇴직금·노후 생활비":[{label:"국민건강보험공단 자격·보험료 확인",url:"https://www.nhis.or.kr/"},{label:"국민연금공단 노후준비 안내",url:"https://www.nps.or.kr/"}],
  "실업급여":[{label:"고용24 실업급여·취업지원 안내",url:"https://www.work24.go.kr/"},{label:"국민연금공단 제도 안내",url:"https://www.nps.or.kr/"}],
  "중장년 재취업·창업":[{label:"고용24 중장년 일자리·훈련 검색",url:"https://www.work24.go.kr/"},{label:"소상공인24 지원사업 확인",url:"https://www.sbiz24.kr/"}],
  "정부지원금·세금":[{label:"정부24 보조금24 맞춤 지원 조회",url:"https://www.gov.kr/portal/rcvfvrSvc/main/nonLogin"},{label:"국세청 세금 신고 안내",url:"https://www.nts.go.kr/"}],
  "건강보험료·건강검진":[{label:"국민건강보험공단 자격·보험료 확인",url:"https://www.nhis.or.kr/"},{label:"국가건강정보포털",url:"https://health.kdca.go.kr/"}],
  "AI 활용·바이브코딩":[{label:"Google 사람 중심 콘텐츠 작성 지침",url:"https://developers.google.com/search/docs/fundamentals/creating-helpful-content?hl=ko"},{label:"Google 생성형 AI 콘텐츠 지침",url:"https://developers.google.com/search/docs/fundamentals/using-gen-ai-content?hl=ko"}],
  "국민연금·퇴직연금":[{label:"국민연금공단 연금 안내",url:"https://www.nps.or.kr/"},{label:"금융감독원 통합연금포털",url:"https://100lifeplan.fss.or.kr/"},{label:"국세청 세금 신고 안내",url:"https://www.nts.go.kr/"}],
  "퇴직 후 부업·N잡":[{label:"고용24 일자리·직업훈련 검색",url:"https://www.work24.go.kr/"},{label:"국세청 소득 신고 안내",url:"https://www.nts.go.kr/"}],
};
...
const slugResources:Record<string,{links?:Array<{label:string;url:string}>;images?:ArticleEnrichment["images"];video?:ArticleEnrichment["video"]}>={
  ...
  "vibe-coding-bootcamp-1":{links:[{label:"원본 영상 00:00 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-2":{links:[{label:"원본 영상 16:23 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=983s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-3":{links:[{label:"원본 영상 24:24 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=1464s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-4":{links:[{label:"원본 영상 31:31 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=1891s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-5":{links:[{label:"원본 영상 52:09 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=3129s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-6":{links:[{label:"원본 영상 1:15:18 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=4518s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-7":{links:[{label:"원본 영상 1:26:46 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=5206s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-8":{links:[{label:"원본 영상 1:38:31 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=5911s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-9":{links:[{label:"원본 영상 1:46:45 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=6405s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-10":{links:[{label:"원본 영상 1:55:48 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=6948s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-11":{links:[{label:"원본 영상 2:07:57 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=7677s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-12":{links:[{label:"원본 영상 2:12:20 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=7940s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-13":{links:[{label:"원본 영상 2:25:12 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=8712s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-14":{links:[{label:"원본 영상 2:38:06 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=9486s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
  "vibe-coding-bootcamp-15":{links:[{label:"원본 영상 2:50:19 구간부터 보기 (조코딩 JoCoding)",url:"https://www.youtube.com/watch?v=P3jFI-VpyLg&t=10219s"},{label:"조코딩 1인 창업가 부트캠프 강의 자료",url:"https://jocoding.net/productbuilder"},{label:"조코딩 주차별 편집본 재생목록",url:"https://www.youtube.com/playlist?list=PLU9-uwewPMe27GtNWsIorePtRO_3vwidD"}]},
};
...
const thumbnailRules: readonly ThumbnailRule[] = [
  ...
  { name: "ai",
    categories: ["AI 활용·바이브코딩", "무료 도구 활용법"],

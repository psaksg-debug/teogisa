// 메뉴 라벨은 사이트를 대표하는 중형 검색어로 둔다. "도구모음"처럼 검색되지 않는
// 일반명사를 쓰면 상단 내비게이션이 만드는 앵커텍스트가 아무 주제도 가리키지 못한다.
// 괄호 안은 네이버 검색광고 키워드도구 기준 월간 검색수(PC+모바일, 2026-09 조회).
// 라벨을 바꿀 때는 MobileMenu와 푸터 '살펴보기'도 같은 문구로 맞춘다 — 같은 페이지를
// 세 가지 이름으로 부르면 앵커텍스트가 흩어진다.
export const portalMenu = [
  { href: "/tools", label: "퇴직금 계산기" },        // 퇴직금계산기 283,400
  { href: "/official-info", label: "실업급여·국민연금" }, // 실업급여 128,800 · 국민연금 255,700
  { href: "/challenge", label: "퇴직 후 부업" },      // 부업 18,820
  { href: "/health", label: "건강검진·질병예방" },     // 건강검진 70,400
];

// 워크북 칸 제목에 구체적인 수입 금액을 쓰지 않는다. 애드센스 정책이 금지하는
// "'단기 고수익' 비법" 주장으로 읽힌다. 금액은 독자가 자기 상황에 맞춰 채우는
// 값이지, 사이트가 제시하는 목표가 아니다.
export const workbookDays = [
  ["현재 수입·지출 한 장 정리", "최근 3개월 통장과 카드 내역에서 월 최소생활비를 적습니다."],
  ["내 수입 목표를 주 단위로 쪼개기", "스스로 정한 목표를 주별·하루별로 나누고 낼 수 있는 작업 시간을 적습니다."],
  ...
  ["수입원 조합표", "빠른 현금형과 축적형 수입원을 무리 없는 비율로 조합합니다."],
...
export const toolCatalog = [
  ...
  { href:"https://myreceipt.adbles.com/", title:"영수증 정리도우미", description:"영수증 사진을 여러 장 올리면 금액을 합산하고 A4 크기의 정리 PDF로 저장합니다.", status:"사용 가능", selfOperated:true },
  { href:"https://proshot.adbles.com/", title:"ProShot AI 사진 스튜디오", description:"휴대폰 셀카 한 장으로 깔끔한 증명사진·비즈니스 헤드샷·스튜디오 프로필을 무료로 만듭니다.", status:"사용 가능", selfOperated:true },
  { href:"https://vpn.adbles.com/", title:"VPN 비교", description:"공용 와이파이에서 쓸 VPN을 노로그 정책·서버 위치·요금 기준으로 견주어 봅니다.", status:"사용 가능", selfOperated:true },

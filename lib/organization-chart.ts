...
export const organizationChartDepartments:OrganizationChartDepartment[]=[
  ...
  {id:"editorial",name:"콘텐츠편집팀",shortName:"편집",lead:"데스크",reportsTo:"대표",responsibility:"공식 출처를 확인하고 애드블스만의 설명·사례·표와 행동 안내로 작성합니다.",workflow:"브리프 인수 → 취재·집필 → 출처·독창성 검토 → 품질검수 요청",members:allEditorialAuthors.map(member=>({id:member.id,name:member.name,title:member.role,responsibility:member.specialty}))},

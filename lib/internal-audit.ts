...
export const auditOfficers:AuditOfficer[] = [
  {id:"audit-executive",name:"강한결",title:"감사책임자 · 관리부장",responsibility:"감사계획 승인, 독립성 확보, 중대사항 대표 보고와 최종 감사의견 확정"},
  {id:"continuous-auditor",name:"박지안",title:"상시감사 담당 · 관리대리",responsibility:"전 프로젝트 표본·정기감사 수행, 증거 수집, 감사조서와 발견사항 작성"},
  {id:"remediation-manager",name:"윤서진",title:"시정조치 관리자 · 관리과장",responsibility:"지적사항 담당자·기한 지정, 진행 추적, 재점검 요청과 완료 증거 관리"},
];
...
export const auditDomains:AuditDomain[] = [
  ...
  {id:"people",name:"조직·인사·업무배정",owner:"강한결",standard:"모든 직원에게 소속·직책·책임·보고선과 가동상태가 지정되어야 한다.",evidence:["전 직원 명부", "부서별 역할", "가동·일시정지 기록"]},
  {id:"resources",name:"리소스·비용·권한",owner:"윤서진",standard:"모든 핵심 자원에 소유부서·관리자·사용기준과 승인절차가 있어야 한다.",evidence:["리소스 등록부", "API·비용 기준", "계정·권한 기준"]},
...
export const AUDIT_SCOPE = "퇴.기.사 전 프로젝트·전 부서·전 직원·자동화·리소스 업무";

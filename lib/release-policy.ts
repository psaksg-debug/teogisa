export const safeReleasePolicy = {
  ...
  updatePaths: [
    ...
    { team:"콘텐츠편집팀 · 콘텐츠 부장", change:"글 초안·본문 변경", delivery:"D1에 초안 저장 후 검토" },
    { team:"품질디자인팀", change:"디자인·코드 변경", delivery:"새 배포 후보에서 빌드·테스트" },
    { team:"홍보마케팅팀", change:"홍보 문안·실행 기록", delivery:"발행된 글만 대상으로 저장" },
    { team:"경영관리팀", change:"감사·자동화·배포 승인", delivery:"게이트 통과 여부와 조치 기록" },
  ],
  gates: [
    "변경 범위와 담당 팀 확인",
    "기존 운영 버전과 분리된 소스 확정",
